...
module.exports = {
  ...
  theme: {
    extend: {
      ...
      colors: {
        // Nouvelle palette Orange/Gris 2025
        'orange': {
          DEFAULT: '#F97316',
          50: '#FFF7ED',
          100: '#FFEDD5',
        ...
        // États - Adaptés à la nouvelle charte
        'success': {
          DEFAULT: '#F97316',
          50: '#FFF7ED',
          100: '#FFEDD5',
      ...
      boxShadow: {
        ...
        'glass-sm': '0 4px 16px rgba(249, 115, 22, 0.08)',
        'glass-lg': '0 12px 40px rgba(249, 115, 22, 0.18)',
        'glass-xl': '0 16px 48px rgba(249, 115, 22, 0.22)',
      ...
      keyframes: {
        ...
        glow: {
          '0%': { 
            boxShadow: '0 0 20px rgba(249, 115, 22, 0.2), 0 0 40px rgba(249, 115, 22, 0.1)' 
          },
          '100%': { 
