  ...
  return (
    <div className="max-w-4xl mx-auto">
      ...
      <div className="text-center mb-8">
        <div className="inline-flex items-center justify-center p-3 bg-gradient-to-r from-indigo-500 to-blue-600 rounded-2xl mb-4">
      ...
      <div className="bg-gradient-to-r from-indigo-50 to-blue-50 rounded-2xl p-8 mb-8">
        ...
        <div className="space-y-4">
          <div className="flex items-start space-x-3">
            ...
            <div>
              <h4 className="font-semibold text-gray-900">Activez votre compte affilié</h4>
              <p className="text-gray-600">Obtenez votre code affilié unique en quelques clics</p>
            </div>
          </div>
          <div className="flex items-start space-x-3">
            <div className="flex-shrink-0 w-8 h-8 bg-indigo-600 text-white rounded-full flex items-center justify-center text-sm font-bold">
            ...
            <div>
              <h4 className="font-semibold text-gray-900">Partagez votre lien</h4>
              <p className="text-gray-600">Recommandez Saloneo à votre réseau professionnel</p>
            </div>
          </div>
          <div className="flex items-start space-x-3">
            <div className="flex-shrink-0 w-8 h-8 bg-indigo-600 text-white rounded-full flex items-center justify-center text-sm font-bold">
            ...
            <div>
              <h4 className="font-semibold text-gray-900">Gagnez des commissions</h4>
              <p className="text-gray-600">Recevez 20% sur chaque abonnement généré</p>
            </div>
          </div>
        </div>
      </div>
      ...
      <div className="bg-white rounded-xl shadow-sm border border-gray-200 p-6">
        ...
        <div className="bg-gray-50 rounded-lg p-4 mb-6 max-h-48 overflow-y-auto text-sm text-gray-600">
          <p className="mb-3">
        ...
        <button
          ...
          className={`
            ...
            ${acceptedTerms && !isActivating
              ? 'bg-gradient-to-r from-indigo-500 to-blue-600 hover:from-indigo-600 hover:to-blue-700 shadow-lg hover:shadow-xl transform hover:scale-105'
