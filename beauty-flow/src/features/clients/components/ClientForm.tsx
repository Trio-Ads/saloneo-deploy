    ...
    <div className="max-w-4xl mx-auto">
      <form onSubmit={handleSubmit} className="space-y-8">
        ...
        <div className="text-center mb-8">
          ...
          <p className="text-gray-600">Remplissez les informations du client pour personnaliser son expérience</p>
        </div>
        ...
        <div className="glass-card p-6">
          <div className="flex items-center space-x-3 mb-6">
            ...
            <h3 className="text-lg font-semibold text-gray-900">Préférences de Communication</h3>
          </div>
